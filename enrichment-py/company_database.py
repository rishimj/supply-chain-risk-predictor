"""
Company Database for Enrichment Service

This is a copy of the company database from flink-processor/src/company_database.py
to keep the enrichment service self-contained.
"""
...
COMPANY_DATABASE = {
    ...
    "CAT": CompanyInfo(
        ...
        keywords=["caterpillar", "heavy machinery"],  # Removed "cat" to avoid false positives
        sector="Industrial",
        is_supplier=True
    ),
